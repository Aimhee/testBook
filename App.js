...
import NaverBook from "./components/NaverBook";
import {
...
import BookScanerScreen from "./components/BookScanerScreen";
...
const TabNavigator = createBottomTabNavigator({
  ...
  defaultNavigationOptions: ({
    ...
    tabBarIcon: ({horizontal,tintColor}) => {const {routeName
      } = navigation.state;
      let iconName;
      if (routeName === 'Home') {
        iconName = `ios-book`;
